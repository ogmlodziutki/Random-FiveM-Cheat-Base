...
bool ImGui::Checkbox( const char* label, bool* v ) {
    ...
    RenderFrame( frame_bb.Min, frame_bb.Max,  settings::visuals::get_accent_color( value->second * style.Alpha ), 0, ROUNDING );
...
bool ImGui::SliderScalar( const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags ) {
    ...
    window->DrawList->AddRectFilled( frame_bb.Min, ImVec2( frame_bb.Min.x + value->second, frame_bb.Max.y ), settings::visuals::get_accent_color( style.Alpha ), 2 );
